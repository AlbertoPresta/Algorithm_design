...
//strassen base
void strassen_aux_base(float **C, const size_t C_f_row, const size_t C_f_col,
               float **A, const size_t A_f_row, const size_t A_f_col,
               float **B, const size_t B_f_row, const size_t B_f_col,
               const size_t n)
{
  ...
  // P1 = A11 x S1
  strassen_aux_base(P[0], 0, 0,
               A, A1X, AX1,
               S[0], 0, 0,
               n2);

  // P2 = S2 x B22
  strassen_aux_base(P[1], 0, 0,
               S[1], 0, 0,
               B, B2X, BX2,
               n2);

  // P3 = S3 x B11
  strassen_aux_base(P[2], 0, 0,
               S[2], 0, 0,
               B, B1X, BX1,
               n2);

  // P4 = A22 x S4
  strassen_aux_base(P[3], 0, 0,
               A, A2X, AX2,
               S[3], 0, 0,
               n2);

  // P5 = S5 x S6
  strassen_aux_base(P[4], 0, 0,
               S[4], 0, 0,
               S[5], 0, 0,
               n2);

  // P6 = S7 x S8
  strassen_aux_base(P[5], 0, 0,
               S[6], 0, 0,
               S[7], 0, 0,
               n2);

  // P7 = S9 x S10
  strassen_aux_base(P[6], 0, 0,
               S[8], 0, 0,
               S[9], 0, 0,
               n2);
...
void strassen_base(float **C,
      float **A, float **B, const size_t n)
{
  strassen_aux_base(C, 0, 0, A, 0, 0, B, 0, 0, n);
}
